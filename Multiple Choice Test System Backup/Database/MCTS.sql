...
values	('','Pham Huu Ngoc','Male', '05/05/1995', '0909090909', '140 Le Trong Tan', 'ngoc@example.com', '',''),
		('','Nguyen Xuan Khang','Female', '07/10/1995', '0808080808', '140 Phan Van Hon', 'khang@example.com', '',''),
		('','Nguyen Van Lan','Female', '15/05/1995', '09493456430', '30/12 Tan Ky Tan Quy', 'lan@example.com', '',''),
		('','Nguyen Xuan Khang Xuan','Female', '07/10/2000', '03827618372', '140 Phan Van Hon', 'khangxuan@example.com', '',''),
		('','Nguyen Van Lan Anh','Male', '15/05/1999', '0367216574', '30/12 Tan Ky Tan Quy', 'lananh@example.com', '','')
